...
[0-9a-f ]+:	c0 3a 40 00 	bralr
[0-9a-f ]+:	92 c8 ff c4 	ldi @\(gr15,-60\),gr9
[0-9a-f ]+:	c0 3a 40 00 	bralr
[0-9a-f ]+:	92 c8 ff cc 	ldi @\(gr15,-52\),gr9
[0-9a-f ]+:	c0 3a 40 00 	bralr
[0-9a-f ]+:	92 fc 00 01 	setlos 0x1,gr9
[0-9a-f ]+:	c0 3a 40 00 	bralr
[0-9a-f ]+:	92 fc f8 11 	setlos 0xf+811,gr9
[0-9a-f ]+:	c0 3a 40 00 	bralr
...
[0-9a-f ]+:	c0 3a 40 00 	bralr
[0-9a-f ]+:	92 fc f8 21 	setlos 0xf+821,gr9
[0-9a-f ]+:	c0 3a 40 00 	bralr
...
[0-9a-f ]+:	92 fc f8 12 	setlos 0xf+812,gr9
[0-9a-f ]+:	80 88 00 00 	nop
[0-9a-f ]+:	00 88 00 00 	nop\.p
[0-9a-f ]+:	80 88 00 00 	nop
...
[0-9a-f ]+:	12 fc f8 13 	setlos\.p 0xf+813,gr9
[0-9a-f ]+:	80 88 00 00 	nop
[0-9a-f ]+:	80 88 00 00 	nop
...
[0-9a-f ]+:	00 88 00 00 	nop\.p
[0-9a-f ]+:	80 88 00 00 	nop
[0-9a-f ]+:	92 fc f8 22 	setlos 0xf+822,gr9
[0-9a-f ]+:	80 88 00 00 	nop
[0-9a-f ]+:	00 88 00 00 	nop\.p
[0-9a-f ]+:	80 88 00 00 	nop
...
[0-9a-f ]+:	12 fc f8 23 	setlos\.p 0xf+823,gr9
[0-9a-f ]+:	80 88 00 00 	nop
[0-9a-f ]+:	80 88 00 00 	nop
...
[0-9a-f ]+:	92 fc 00 01 	setlos 0x1,gr9
[0-9a-f ]+:	92 fc 10 01 	setlos 0x1001,gr9
[0-9a-f ]+:	92 c8 ff a4 	ldi @\(gr15,-92\),gr9
[0-9a-f ]+:	00 88 00 00 	nop\.p
[0-9a-f ]+:	80 88 00 00 	nop
