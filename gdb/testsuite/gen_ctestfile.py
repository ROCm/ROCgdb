...
"""
Generate gdb/testsuite/CTestTestfile.cmake from test_categories.yaml.

The generated file ships verbatim through TheRock's testsuite install rule
(debug-tools/rocgdb/CMakeLists.txt installs the entire gdb/testsuite/ tree)
and lands at:
...
This generator is a developer tool. After editing test_categories.yaml, run:
    ...
    python3 gdb/testsuite/gen_ctestfile.py
...
def render(yaml_path: Path) -> str:
    ...
    lines = [
        "# Generated by gdb/testsuite/gen_ctestfile.py from",
        "# gdb/testsuite/test_categories.yaml.  Do not edit by hand.",
        "#",
