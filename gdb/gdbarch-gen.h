...
bool gdbarch_active_lanes_mask_p (struct gdbarch *gdbarch);

using gdbarch_active_lanes_mask_ftype = simd_lanes_mask_t (struct gdbarch *gdbarch, thread_info *tp);
simd_lanes_mask_t gdbarch_active_lanes_mask (struct gdbarch *gdbarch, thread_info *tp);
void set_gdbarch_active_lanes_mask (struct gdbarch *gdbarch, gdbarch_active_lanes_mask_ftype *active_lanes_mask);

/* Return the number of lanes supported by the thread. */

using gdbarch_supported_lanes_count_ftype = int (struct gdbarch *gdbarch, thread_info *tp);
int gdbarch_supported_lanes_count (struct gdbarch *gdbarch, thread_info *tp);
void set_gdbarch_supported_lanes_count (struct gdbarch *gdbarch, gdbarch_supported_lanes_count_ftype *supported_lanes_count);
...
using gdbarch_used_lanes_count_ftype = int (struct gdbarch *gdbarch, thread_info *tp);
int gdbarch_used_lanes_count (struct gdbarch *gdbarch, thread_info *tp);
void set_gdbarch_used_lanes_count (struct gdbarch *gdbarch, gdbarch_used_lanes_count_ftype *used_lanes_count);
...
using gdbarch_value_from_register_ftype = struct value *(struct gdbarch *gdbarch, struct type *type, int regnum, const frame_info_ptr &this_frame, ULONGEST offset, ULONGEST bit_offset);
struct value *gdbarch_value_from_register (struct gdbarch *gdbarch, struct type *type, int regnum, const frame_info_ptr &this_frame, ULONGEST offset, ULONGEST bit_offset);
...
CORE_ADDR gdbarch_integer_to_address (struct gdbarch *gdbarch, struct type *type, const gdb_byte *buf, arch_addr_space_id address_space_id);
...
bool gdbarch_address_spaces_p (struct gdbarch *gdbarch);

using gdbarch_address_spaces_ftype = gdb::array_view<const arch_addr_space> (struct gdbarch *gdbarch);
gdb::array_view<const arch_addr_space> gdbarch_address_spaces (struct gdbarch *gdbarch);
void set_gdbarch_address_spaces (struct gdbarch *gdbarch, gdbarch_address_spaces_ftype *address_spaces);
...
using gdbarch_address_space_id_from_core_address_ftype = arch_addr_space_id (CORE_ADDR address);
arch_addr_space_id gdbarch_address_space_id_from_core_address (struct gdbarch *gdbarch, CORE_ADDR address);
void set_gdbarch_address_space_id_from_core_address (struct gdbarch *gdbarch, gdbarch_address_space_id_from_core_address_ftype *address_space_id_from_core_address);

/* Extracts segment address from core address.
   TODO: This hook is a quick fix until a proper address space support
   is added and should not be pushed upstream. */

using gdbarch_segment_address_from_core_address_ftype = CORE_ADDR (CORE_ADDR address);
CORE_ADDR gdbarch_segment_address_from_core_address (struct gdbarch *gdbarch, CORE_ADDR address);
void set_gdbarch_segment_address_from_core_address (struct gdbarch *gdbarch, gdbarch_segment_address_from_core_address_ftype *segment_address_from_core_address);

/* Converts segment address to core address.
   TODO: This hook is a quick fix until a proper address space support
   is added and should not be pushed upstream. */

using gdbarch_segment_address_to_core_address_ftype = CORE_ADDR (arch_addr_space_id address_space_id, CORE_ADDR address);
...
using gdbarch_get_watchable_aliases_ftype = std::vector<addr_range> (struct gdbarch *gdbarch, ptid_t ptid, int simd_lane, addr_range range);
std::vector<addr_range> gdbarch_get_watchable_aliases (struct gdbarch *gdbarch, ptid_t ptid, int simd_lane, addr_range range);
void set_gdbarch_get_watchable_aliases (struct gdbarch *gdbarch, gdbarch_get_watchable_aliases_ftype *get_watchable_aliases);
...
using gdbarch_show_verbose_trap_inline_frame_ftype = bool (struct gdbarch *gdbarch, struct symbol *func, enum gdb_signal stop_signal);
bool gdbarch_show_verbose_trap_inline_frame (struct gdbarch *gdbarch, struct symbol *func, enum gdb_signal stop_signal);
