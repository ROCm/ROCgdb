static const struct dis386 evex_table[][256] = {
  ...
  /* EVEX_MAP5_ */
  {
    ...
    { Bad_Opcode },
    { Bad_Opcode },
    { PREFIX_TABLE (PREFIX_EVEX_MAP5_36) },
    { PREFIX_TABLE (PREFIX_EVEX_MAP5_37) },
    /* 38 */
    { VEX_W_TABLE (EVEX_W_MAP5_38) },
    { VEX_W_TABLE (EVEX_W_MAP5_39) },
    { VEX_W_TABLE (EVEX_W_MAP5_3A) },
    { VEX_W_TABLE (EVEX_W_MAP5_3B) },
    { VEX_W_TABLE (EVEX_W_MAP5_3C) },
    { PREFIX_TABLE (PREFIX_EVEX_MAP5_3D) },
    { VEX_W_TABLE (EVEX_W_MAP5_3E) },
    { Bad_Opcode },
    /* 40 */
    { Bad_Opcode },
    { Bad_Opcode },
